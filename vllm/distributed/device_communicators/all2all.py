...
class FlashInferNVLinkTwoSidedManager(All2AllManagerBase):
    ...
    def checkpoint_restore(self) -> None:
        if self.initialized:
            ...
            restored_comm = MnnvlMemory.get_comm(self.mapping)
            MnnvlMoe.moe_workspace.reattach_handles(comm=restored_comm)
            MnnvlMoe.moe_prepare_workspace.reattach_handles(comm=restored_comm)
