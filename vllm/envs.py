...
if TYPE_CHECKING:
    ...
    VLLM_ALLGATHER_USE_FLASHINFER: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to use FlashInfer symmetric all-gather
    "VLLM_ALLGATHER_USE_FLASHINFER": lambda: bool(
        int(os.getenv("VLLM_ALLGATHER_USE_FLASHINFER", "0"))
    ),
